...
var onGetPatients = function onGetPatients(event) {
  event.preventDefault();
  api.getPatients().then(ui.getPatientsSuccess).catch(ui.failure);
};

var onGetAppointments = function onGetAppointments(event, data) {
  console.log(data);
  api.getAppointments().then(ui.getAppointmentsSuccess).catch(ui.failure);
};

var onGetUsers = function onGetUsers(event) {
  api.getUsers().then(ui.getUserSuccess).catch(ui.failure);
};

var onChangeDoctor = function onChangeDoctor(event) {
  event.preventDefault();
  var docId = $('#doc-id').val();
  var appId = event.target.name;
  console.log(docId + ' ' + appId);
  api.changeDoctor(docId, appId).then(ui.changeDoctorSuccess).catch(ui.failure);
};
...
var onDeleteAppointment = function onDeleteAppointment(event) {
  ...
  api.deleteAppointment(id).then(ui.deleteAppointmentSuccess).then(refresh).catch(ui.failure);
};

var onDeleteUser = function onDeleteUser(event) {
  event.preventDefault();
  console.log('User data is ' + event.target.name);
  api.deleteUser().then(ui.deleteAppointmentSuccess).then(refresh).catch(ui.failure);
};

var onClearAppointments = function onClearAppointments(event) {
  ui.clearAppointments();
};

var onCreateAppointment = function onCreateAppointment(event) {
  event.preventDefault();
  var type = $('#app-type').val();
  var date = $('#app-date').val();
  var doctor = $('#app-doctor').val();
  var patient = $('#app-patient').val();
  console.log(type + ' ' + patient);
  api.createAppointment(type, date, doctor, patient).then(ui.createAppointmentSuccess).catch(ui.failure);
};

// MODAL CLICK HANDLERS
var toggleDoctorModal = function toggleDoctorModal() {
  $('#change-doctor').toggleClass('is-active');
};
var toggleDiagnosisModal = function toggleDiagnosisModal() {
  $('#update-diagnosis').toggleClass('is-active');
};

var toggleCreateModal = function toggleCreateModal() {
...
var onUpdateDiagnosis = function onUpdateDiagnosis(event) {
  event.preventDefault();
  var diagnosis = $('#diagnosis').val();
  var id = event.target.name;
  api.changeDiagnosis(diagnosis, id).then(ui.changeDoctorSuccess).catch(ui.failure);
};
...
var changeDoctor = function changeDoctor(docId, appId) {
  return $.ajax({
...
var changeDiagnosis = function changeDiagnosis(diagnosis, id) {
...
var deleteAppointment = function deleteAppointment(id) {
  return $.ajax({
...
var createAppointment = function createAppointment(type, date, doctor, patient) {
...
var showPatientsTemplate = __webpack_require__(20);
var showAppointmentsTemplate = __webpack_require__(38);
var showUsersTemplate = __webpack_require__(39);
// const appEvents = require('./events.js')

var getPatientsSuccess = function getPatientsSuccess(data) {
  console.log(data);
  var showPatientsHtml = showPatientsTemplate({ users: data.user });
  $('.p-content').append(showPatientsHtml);
};

var getAppointmentsSuccess = function getAppointmentsSuccess(data) {
  console.log(data);
  var showAppointmentsHtml = showAppointmentsTemplate({ user: data.user.appointments, doctor: data.user.doctors });
  $('#app-content').append(showAppointmentsHtml);
};

var getUserSuccess = function getUserSuccess(data) {
  console.log(data);
  var showUsersHtml = showUsersTemplate({ users: data.users });
  $('#user-content').append(showUsersHtml);
};

var changeDoctorSuccess = function changeDoctorSuccess() {
  console.log('Beast Mode');
  $('.changed').html('Updated');
};

var deleteAppointmentSuccess = function deleteAppointmentSuccess(data) {
  if (data) {
    console.log(data);
  } else {
    console.log('Success');
...
var createAppointmentSuccess = function createAppointmentSuccess() {
  console.log('Beast Mode');
  $('.changed').html('Updated');
};

var clearAppointments = function clearAppointments() {
  $('.content').empty();
};

var onDeleteDiagnosis = function onDeleteDiagnosis() {
...
module.exports = {
  getPatientsSuccess: getPatientsSuccess,
  failure: failure,
  onDeleteDiagnosis: onDeleteDiagnosis,
  getAppointmentsSuccess: getAppointmentsSuccess,
  changeDoctorSuccess: changeDoctorSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"partial","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + " -->\n  <!-- Don't uncomment yet -->\n\n <!-- Developers, why are we using data-id and not just id? -->\n  <li><h1 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> <small>Patient: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.given_name : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.family_name : stack1), depth0))
    + "</small></h1>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.diagnosis : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  <li><button id=\"deleteDiagnosis\" name=\"button is-warning\">Delete Book</button></li>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      Diagnosis: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.diagnosis : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.patients : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"box appointment\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <div class=\"columns\">\n    <div class=\"column is-3 name\">\n      <p>\n        <span class=\"title is-bold\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.app_type : stack1), depth0))
    + "</span>\n      </p>\n    </div>\n    <div class=\"column is-2 followers has-text-centered\">\n      <p class=\"stat-val\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.doctor_id : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.doctor_id : stack1)) != null ? stack1.family_name : stack1), depth0))
    + "</p>\n      <a class=\"modal-doctor-toggle\" href=\"#\">Doctor ID</a>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-2 following has-text-centered\">\n      <h1 class=\"stat-val\">12:00</h1>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-2 likes has-text-centered\">\n      <p class=\"is-4\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</p>\n      <a>Appointent ID</a>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-1\">\n      <button id=\"delete-appointment\" name=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " \"class=\"button is-danger is-outlined\">Delete Appointment</button>\n    </div>\n  </div>\n</div>\n\n<!-- DOCTOR MODAL-->\n<div id=\"change-doctor\" class=\"modal\">\n  <div class=\"modal-background\"></div>\n  <div class=\"modal-content box\">\n    <form id=\"change-doctor\">\n          <!-- <legend clas>Change Doctor</legend><br>\n          <input class=\"input\" id=\"doc-id\" type=\"text\" value=\"\" placeholder=\"Doctor ID\"> -->\n\n          <!-- DOCTOR DROPDOWN -->\n          <div class=\"control\">\n            <div class=\"select\">\n              <select id=\"doc-id\">\n                <option value=\"1\">1 - Dr. Snow</option>\n                <option value=\"2\">2 - Dr. Targaryn</option>\n                <option value=\"3\">3 - Dr. Stark</option>\n              </select>\n            </div>\n          </div>\n          <!-- DOCTOR DROPDOWN END -->\n\n          <!-- <input class=\"input\" id=\"last-name\" type=\"text\" value=\"\" placeholder=\"Last Name\"><br><br> -->\n          <input class=\"button is-info\" id=\"change-doc\" type=\"submit\" name=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Change Doctor\">\n          <p class=\"changed has-text-danger\"></p>\n      </form>\n    <button class=\"modal-close is-large modal-doctor-toggle refresh\" aria-label=\"\">Close</button>\n  </div>\n</div>\n<!-- END OF DOCTOR MODAL-->\n\n<!-- DIAGNOSIS MODAL-->\n<div id=\"update-diagnosis\" class=\"modal\">\n  <div class=\"modal-background\"></div>\n  <div class=\"modal-content box\">\n    <form id=\"change-diagnosis\">\n          <legend clas>Change Diagnosis</legend><br>\n          <input class=\"input\" id=\"diagnosis\" type=\"text\" value=\"\" placeholder=\"Diagnosis\">\n          <input class=\"input button is-info\" id=\"change-patient-diagnosis\" type=\"submit\" name=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.patient : stack1)) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Change Diagnosis\">\n          <p class=\"changed has-text-danger\"></p>\n      </form>\n    <button class=\"modal-close is-large modal-diagnosis-toggle refresh\" aria-label=\"\">Close</button>\n  </div>\n</div>\n<!-- END OF DIAGNOSIS MODAL-->\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.user : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"box appointment\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <div class=\"columns\">\n    <div class=\"column is-3 name\">\n      <p>\n        <span class=\"title is-bold\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.patients : stack1), depth0))
    + "</span>\n        <!-- <span class=\"button is-danger is-outlined follow\">delete</span> -->\n      </p>\n    </div>\n    <div class=\"column is-2 followers has-text-centered\">\n      <p class=\"stat-val\">"
    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.patient : stack1)) != null ? stack1.doctor : stack1)) != null ? stack1.given_name : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.patient : stack1)) != null ? stack1.doctor : stack1)) != null ? stack1.family_name : stack1), depth0))
    + "</p>\n      <a class=\"modal-doctor-toggle\" href=\"#\">Change Doctor</a>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-2 following has-text-centered\">\n      <p class=\"stat-val\">12:00pm</p>\n      <a href=\"#\">Change Time</a>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-2 likes has-text-centered\">\n      <p class=\"is-4\">"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.patient : stack1)) != null ? stack1.diagnosis : stack1), depth0))
    + "</p>\n      <a class=\"modal-diagnosis-toggle\"href=\"#\">Change Diagnosis</a>\n      <!-- Modal to patch request -->\n    </div>\n    <div class=\"column is-1\">\n      <button id=\"delete-user\" name=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.doctor : stack1), depth0))
    + " \"class=\"button is-danger is-outlined\">Delete Appointment</button>\n    </div>\n  </div>\n</div>\n\n<!-- DOCTOR MODAL-->\n<!-- <div id=\"change-doctor\" class=\"modal\">\n  <div class=\"modal-background\"></div>\n  <div class=\"modal-content box\">\n    <form id=\"change-doctor\">\n          <legend clas>Change Doctor</legend><br>\n          <input class=\"input\" id=\"first-name\" type=\"text\" value=\"\" placeholder=\"First Name\">\n          <input class=\"input\" id=\"last-name\" type=\"text\" value=\"\" placeholder=\"Last Name\"><br><br>\n          <input class=\"button is-info\" id=\"change-doc\" type=\"submit\" name=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.app : depth0)) != null ? stack1.doctor : stack1)) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Change Doctor\">\n          <p class=\"changed has-text-danger\"></p>\n      </form>\n    <button class=\"modal-close is-large modal-doctor-toggle refresh\" aria-label=\"\">Close</button>\n  </div>\n</div> -->\n<!-- <button class=\"modal-doctor-toggle button is-primary\">Modal</button> -->\n<!-- END OF DOCTOR MODAL-->\n\n<!-- DIAGNOSIS MODAL-->\n<!-- <div id=\"update-diagnosis\" class=\"modal\">\n  <div class=\"modal-background\"></div>\n  <div class=\"modal-content box\">\n    <form id=\"change-diagnosis\">\n          <legend clas>Change Diagnosis</legend><br>\n          <input class=\"input\" id=\"diagnosis\" type=\"text\" value=\"\" placeholder=\"Diagnosis\">\n          <input class=\"input button is-info\" id=\"change-patient-diagnosis\" type=\"submit\" name=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.app : depth0)) != null ? stack1.patient : stack1)) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Change Diagnosis\">\n          <p class=\"changed has-text-danger\"></p>\n      </form>\n    <button class=\"modal-close is-large modal-diagnosis-toggle refresh\" aria-label=\"\">Close</button>\n  </div>\n</div> -->\n<!-- <button class=\"modal-doctor-toggle button is-primary\">Modal</button> -->\n<!-- END OF DIAGNOSIS MODAL-->\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
